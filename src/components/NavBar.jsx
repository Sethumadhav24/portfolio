  ...
  return (
    <nav className="mb-20 flex items-center justify-between py-6">
      ...
      <div className="m-8 flex items-center justify-center gap-4 text-2xl">
        <a href="https://drive.google.com/file/d/1EGdBoW2q-3M0UK6FS3Mj2wJS8D1V4PeO/view?usp=sharing" target="_blank" rel="noopener noreferrer">
          Resume
        </a>
        ...
        <a href="https://x.com/sethumadhav2467" target="_blank" rel="noopener noreferrer">
          <FaSquareXTwitter />
        </a>
        <a href="https://leetcode.com/u/sethumadhav2467/" target="_blank" rel="noopener noreferrer">
          <SiLeetcode />
        </a>
      </div>
    </nav>
